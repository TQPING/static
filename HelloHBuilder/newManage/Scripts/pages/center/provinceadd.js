...
var provinceadd = {
    ...
    holderSubmit: function () {
        ...
        $.post('/Center/CenterProvinceAdd', postData, function (result) {
            if (result.status == 1) {
                swal("添加成功", '', 'success').then(function () {
                    location.href = '/Center/ProvinceList';
                });
            } else {
        ...
        //alert(JSON.stringify($('#holderform').serializeObject()));
        //alert('OK');
    }
